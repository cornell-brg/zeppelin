...
task test_case_directed_mulh_2_x0();
  ...
  h.asm( 'h208, "mulh x0, x0, x0" );
  h.asm( 'h20c, "mulh x0, x0, x1" );
  h.asm( 'h210, "mulh x0, x2, x0" );
  h.asm( 'h214, "mulh x3, x0, x1" );
  h.asm( 'h218, "mulh x4, x2, x0" );

  // Check each executed instruction

  h.check_trace( 'h200,  1, 'h01, 1 ); // addi x1, x0, 1
  h.check_trace( 'h204,  2, 'h02, 1 ); // addi x2, x0, 2
  h.check_trace( 'h208, 'x, 'x,   0 ); // mulh x0, x0, x0
  h.check_trace( 'h20c, 'x, 'x,   0 ); // mulh x0, x0, x1
  h.check_trace( 'h210, 'x, 'x,   0 ); // mulh x0, x2, x0
  h.check_trace( 'h214,  3, 'h00, 1 ); // mulh x3, x0, x1
  h.check_trace( 'h218,  4, 'h00, 1 ); // mulh x4, x2, x0
...
task test_case_directed_mulh_3_upper_bit();
  ...
  h.asm( 'h20c, "mulh x4,  x1,  x2"   );
  h.asm( 'h210, "mulh x5,  x2,  x3"   );
  h.asm( 'h214, "mulh x6,  x1,  x3"   );
  ...
  h.check_trace( 'h20c, 4, 'hc000_0800, 1 ); // mulh x4,  x1,  x2
  h.check_trace( 'h210, 5, 'hffff_f800, 1 ); // mulh x5,  x2,  x3
  h.check_trace( 'h214, 6, 'h0000_0800, 1 ); // mulh x6,  x1,  x3
