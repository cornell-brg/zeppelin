...
task test_case_directed_bne_1_basic();
  ...
  h.check_trace( 'h204, 'x, 'x,          0 ); // bne  x1, x0, 0x20c
...
task test_case_directed_bne_4_chain();
  ...
  h.asm( 'h218, "bne  x1,  x2, 0x220" );
  h.asm( 'h21c, "addi x7,  x0, 2"     );
  h.asm( 'h220, "bne  x3,  x4, 0x228" );
  h.asm( 'h224, "addi x8,  x0, 3"     );
  h.asm( 'h228, "bne  x5,  x6, 0x230" );
  ...
  h.check_trace( 'h218, 'x, 'x, 0 ); // bne  x1,  x2, 0x220
  h.check_trace( 'h220, 'x, 'x, 0 ); // bne  x3,  x4, 0x228
  h.check_trace( 'h228, 'x, 'x, 0 ); // bne  x5,  x6, 0x230
...
task test_case_directed_bne_5_backward();
  ...
  h.asm( 'h208, "addi x12, x0, 3"     );
  h.asm( 'h20c, "addi x15, x0, 4"     );

  h.asm( 'h210, "bne  x1,  x0, 0x244" ); // --------.
...
task test_case_directed_bne_6_loop();
  ...
  h.asm( 'h20c, "bne  x1, x0, 0x204" ); // --'
  h.asm( 'h210, "addi x2, x0, 1"     ); //
  h.asm( 'h214, "addi x3, x0, 2"     ); //

  // Check each executed instruction

  h.check_trace( 'h200,  1,  4, 1 ); // addi x1, x0, 4
  h.check_trace( 'h204,  1,  3, 1 ); // addi x1, x1, -1
  h.check_trace( 'h208,  1,  2, 1 ); // addi x1, x1, -1
  h.check_trace( 'h20c, 'x, 'x, 0 ); // bne  x1, x0, 0x204
  h.check_trace( 'h204,  1,  1, 1 ); // addi x1, x1, -1
...
task test_case_directed_bne_7_loop_self();
  ...
  h.asm( 'h200, "addi x1, x0, 1"     );
  h.asm( 'h204, "bne  x1, x0, 0x204" );

  // Check each executed instruction

  h.check_trace( 'h200,  1,  1, 1 ); // addi x1, x0, 1
  h.check_trace( 'h204, 'x, 'x, 0 ); // bne  x1, x0, 0x204
  h.check_trace( 'h204, 'x, 'x, 0 ); // bne  x1, x0, 0x204
  h.check_trace( 'h204, 'x, 'x, 0 ); // bne  x1, x0, 0x204
  h.check_trace( 'h204, 'x, 'x, 0 ); // bne  x1, x0, 0x204
