...
// vvmul.cpp
//========================================================================
// A basic vvmul benchmark for Zeppelin
...
void vvmul( int* dest, int* src0, int* src1, int size )
{
...
int main( void )
{
  ...
  vvmul( dest, eval_src0, eval_src1, eval_size );
  ...
  ubmark_stats_print( "vvmul", num_cycles, num_insts );
